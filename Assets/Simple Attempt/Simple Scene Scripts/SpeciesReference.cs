...
public static class SpeciesReference
{
    ...
    public static SpeciesAttributes[] defaultSpeciesAttributes = new SpeciesAttributes[]
    {
        ...
        new SpeciesAttributes("Blob", SPECIES.BLOB,
            new Rule(//Life rule
                new Condition[] { new Condition(SOURCE.LIVING_NEIGHBOR_MATCHING_SPECIES_COUNT, CONDITON.VALUE_OUTSIDE_RANGE, new Vector2Int(2, 3), null, new List<SPECIES> { SPECIES.BLOB, SPECIES.FLOPPER, SPECIES.GOBLIN }, null) },
                new Result[] { new Result(LIFE_EFFECT.KILL, SPECIES.NONE, STATE.NONE) } ),
            new Rule(//Propigation rule
                new Condition[] { new Condition(SOURCE.LIVING_NEIGHBOR_MATCHING_SPECIES_COUNT, CONDITON.VALUE_WITHIN_RANGE, new Vector2Int(3, 3), null, new List<SPECIES> { SPECIES.BLOB }, null) },
        ...
        new SpeciesAttributes("Flopper", SPECIES.FLOPPER,
            new Rule(//Life rule
                new Condition[] { new Condition(SOURCE.LIVING_NEIGHBOR_MATCHING_SPECIES_COUNT, CONDITON.VALUE_OUTSIDE_RANGE, new Vector2Int(2, 3), null, new List<SPECIES>{ SPECIES.BLOB, SPECIES.FLOPPER }, null) },
                new Result[] { new Result(LIFE_EFFECT.KILL, SPECIES.NONE, STATE.NONE) } ),
            new Rule(//Propigation rule
                new Condition[] { new Condition(SOURCE.LIVING_NEIGHBOR_MATCHING_SPECIES_COUNT, CONDITON.VALUE_WITHIN_RANGE, new Vector2Int(2, 3), null, new List<SPECIES>{ SPECIES.BLOB}, null) },
        ...
        new SpeciesAttributes("Goblin", SPECIES.GOBLIN,
            new Rule(//Life rule
                new Condition[] { new Condition(SOURCE.LIVING_NEIGHBOR_MATCHING_SPECIES_COUNT, CONDITON.VALUE_OUTSIDE_RANGE, new Vector2Int(2, 3), null, new List<SPECIES>{ SPECIES.GOBLIN, SPECIES.FLOPPER, SPECIES.ROCK }, null) },
                new Result[] { new Result(LIFE_EFFECT.KILL, SPECIES.NONE, STATE.NONE) } ),
            new Rule(//Propigation rule
                new Condition[] {new Condition(SOURCE.LIVING_NEIGHBOR_MATCHING_SPECIES_COUNT, CONDITON.VALUE_WITHIN_RANGE, new Vector2Int(2, 3), null, new List<SPECIES>{ SPECIES.GOBLIN, SPECIES.FLOPPER, SPECIES.ROCK }, null) },
