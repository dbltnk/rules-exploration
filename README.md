...
* **P1** - unusedConditions.AddRange(ruleObject.possibleConditions)  modifies the SO, not just the rule at runtime.
* **P2** - Compare Species Groups and Compare States dropdowns on Possible Conditions on RulesObject are flickering.
